...
The crucial observation is that boundaries of spin islands serve as acceptable high-temperature graphs and vice versa, establishing a one-to-one correspondence between terms [[7.D3]]. Defining \(g\) to denote the logarithm of either series, the free energy satisfies
