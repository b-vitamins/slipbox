...
The graphical representation [[7.D2]] makes manifest that only topologically closed paths contribute, establishing the foundation for both duality arguments [[7.5]] and the connection to random walks [[7.7]]. The choice of $\tanh K$ as expansion parameter proves essential: it naturally emerges in duality relations and prevents the over-counting that would arise with bare coupling $K$.