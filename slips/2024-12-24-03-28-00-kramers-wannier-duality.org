...
The duality emerges from comparing the graphical expansions at opposite temperature extremes. The low-temperature series enumerates droplets of overturned spins weighted by their perimeter [[7.2]], while the high-temperature series counts closed loops on the lattice weighted by their length [[7.3]]. The profound observation is that droplet boundaries constitute valid loops and vice versa—the two expansions enumerate identical geometric objects with different statistical weights.
