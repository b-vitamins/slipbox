...
#+FILETAGS: :physics:spof:ch6:rg:flow:figure:
...
Flow diagrams transform abstract recursion relations [[id:4d8f3c2e-7a9b-5f2c-8e3d-7a9b5f2c8e3d][Recursion Relations]] into geometric intuition. Stable fixed points are attractors where physics becomes scale-invariant; unstable fixed points are organizing centers separating different phases. The one-dimensional flow's simplicity—no closed orbits, no chaotic regions, no intermediate fixed points—reflects the absence of competing ordered phases. This visual representation makes clear why no phase transition occurs: every finite-temperature system flows inexorably toward disorder. The method extends to any parameter space, with fixed points corresponding to scale-invariant theories and flows revealing how microscopic parameters determine macroscopic behavior.

**See also:** [[id:5d8f4c3e-7a9b-6f2c-8e3d-7a9b6f2c8e3d][Fixed Point Structure]] for mathematical analysis, [[id:6e9d8f3c-9a9b-6f2c-8e8d-9a9b6f2c8e8d][Phase Portraits]] for visualization techniques, [[id:7e8d9f3c-9a9b-5f2c-8e8d-9a9b5f2c8e8d][Flow Topology]] for classification.