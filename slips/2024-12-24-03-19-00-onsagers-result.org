...
where \(t = \tanh K\). This version directly emerges from the determinant of the directional transfer matrix [[7.35]], making manifest how topological constraints modify the phantom loop result.
