...
To set up a local environment for browsing and editing these notes, run `./setup-dev.sh` while online. It installs Emacs and caches the required Org-roam packages for offline use.
